...
```sh
dsh plugin --profile <name> add @truly-private/omdsh-subagent-codex
dsh plugin --profile <name> add @truly-private/omdsh-subagent-claude-code
dsh plugin --profile <name> remove @truly-private/omdsh-subagent-codex
dsh plugin --profile <name> remove @truly-private/omdsh-subagent-claude-code
```
