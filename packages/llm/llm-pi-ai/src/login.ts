...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@truly-private/omdsh-authorization'
import { isCredentialKeySegment } from '@truly-private/omdsh-credentials'
