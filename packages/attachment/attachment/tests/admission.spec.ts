...
import { admitEncodedImages } from '@truly-private/omdsh-attachment'
import type { ImageAttachmentRef, SaveImageAttachment } from '@truly-private/omdsh-attachment/types'
