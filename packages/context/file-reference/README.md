# `@truly-private/omdsh-file-reference`
...
Indirectly, through `@truly-private/omdsh-file-reference-local`, which conditionally contributes this package's stable file-reference guidance.
