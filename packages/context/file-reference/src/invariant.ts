/**
 * Package-owned invariant companion for `@truly-private/omdsh-file-reference`.
 * @module @truly-private/omdsh-file-reference/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-file-reference'
