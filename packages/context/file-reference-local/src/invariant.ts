/**
 * Package-owned invariant companion for `@truly-private/omdsh-file-reference-local`.
 * @module @truly-private/omdsh-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-file-reference-local'
