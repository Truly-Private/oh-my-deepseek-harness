/**
 * Package-owned invariant companion for `@truly-private/omdsh-code-runtime-python`.
 * @module @truly-private/omdsh-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-code-runtime-python'
