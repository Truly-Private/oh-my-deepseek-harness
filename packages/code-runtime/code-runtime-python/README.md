...
CPython-subprocess implementation of the [`@truly-private/omdsh-code-runtime`](../code-runtime/README.md) seam. Companion to [`@truly-private/omdsh-code-runtime-worker-thread`](../code-runtime-worker-thread/README.md); trades the Node worker thread for a fresh `python3` subprocess so model code is Python instead of TypeScript.
