 ...
 * @module @truly-private/omdsh-client-web/src/boot
 */
...
import type {} from '@truly-private/omdsh-client-ui-renderer/client'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    try {
      ...
      // is `ClientTransportHooks`, owned by @truly-private/omdsh-client-connection;
