/**
 * Package-owned invariant companion for `@truly-private/omdsh-client-ui-reference`.
 * @module @truly-private/omdsh-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-client-ui-reference'
