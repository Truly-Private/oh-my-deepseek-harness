...
import type { IndexInjection } from '@truly-private/omdsh-host-webserver'
...
const CLIENT_MODULES_ID = '@truly-private/omdsh-client-modules'

/** Dynamic package whose ordinary client bundle must be registered before plugin boot starts. */
const CLIENT_RUNTIME_ID = '@truly-private/omdsh-client-runtime'
