/**
 * Package-owned invariant companion for `@truly-private/omdsh-tool-pwsh-persistent`.
 * @module @truly-private/omdsh-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@truly-private/omdsh-tool-pwsh-persistent'
