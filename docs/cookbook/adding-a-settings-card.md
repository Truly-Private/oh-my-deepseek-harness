...
import type {} from '@truly-private/omdsh-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@truly-private/omdsh-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@truly-private/omdsh-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
